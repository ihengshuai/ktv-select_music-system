<template>
    <div class="language">
        ...
        <div class="wrapper">
            ...
            <Row class="row-song" style="padding:20px 150px;" v-for="(item, index) in styleSongs" :key="index">
                <Col :span="3" style="cursor:default;">
...
export default {
    ...
    data(){
        return{
            styleSongs:[],
            languageOption:["传统歌曲", "民歌歌曲", "摇滚歌曲", "伴奏歌曲", "古风歌曲"],
            allTableData:[],
            paginations: {
                page_index: 1, // 当前位于哪页
                total: 0, // 总数
    ...
    methods:{
        ...
        handleCurrentChange(page) {
            ...
            // 设置默认分页数据
            this.styleSongs = table.filter((item, index) => {
        ...
        handleSizeChange(page_size) {
            ...
            this.styleSongs = this.allTableData.filter((item, index) => {
